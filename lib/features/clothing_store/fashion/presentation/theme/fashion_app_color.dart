...
class FashionAppColors {
  ...
  //static const tertiaryContainer = Color(0xFF787676);
  static const brightGray = Color(0xFFEDEDED);

  // Error
  static const error = Color(0xFFD9301E);

  // Outline
  static const outline = Color(0xFFEDEDED);
